...
#include "Csm_Cfg.h"
#include "../../V2xManagment/V2xManagment.h"
...
typedef struct {
	 uint32 CsmQueueSize;
	const CryIfChannel *CsmChannelRef;
 ...
 *                      external variables                                    *
 *******************************************************************************/
extern const CsmCallback CsmJobPrimitiveCallbackRef[3];
