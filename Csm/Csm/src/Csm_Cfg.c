...
const CsmCallback CsmJobPrimitiveCallbackRef[3]=
 ...
 const CsmPrimitives CsmJobPrimitiveRef[3]=
 {{0x2C,0,0,32},{0x2C,0,0,32},{3,0,0,32}};
...
const CsmJob generateSignatureCsmJob={
		...
		&csmKey,
		&CsmJobPrimitiveCallbackRef[0],
		&CsmJobPrimitiveRef[0],
		&csmQueue
};
...
const CsmJob verifySignatureCsmJob={
		...
		CRYPTO_PROCESSING_ASYNC,
		&csmKey,
		&CsmJobPrimitiveCallbackRef[1],
		&CsmJobPrimitiveRef[1],
		&csmQueue
};
const CsmJob hashCsmJob={
		...
		CRYPTO_PROCESSING_ASYNC,
		&csmKey,
		&CsmJobPrimitiveCallbackRef[2],
		&CsmJobPrimitiveRef[2],
		&csmQueue
};
