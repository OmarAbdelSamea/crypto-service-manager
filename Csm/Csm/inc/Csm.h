...
typedef enum {CRYPTO_ALGOMODE_NOT_SET, CRYPTO_ALGOMODE_CUSTOM = 0xff}CsmHashAlgorithmMode;
...
/***********Signature*****************/
typedef enum{CRYPTO_ALGOFAM_BRAINPOOL = 0x18,
	CRYPTO_ALGOFAM_CUSTOM = 0xFF,
	CRYPTO_ALGOFAM_ECCNIST = 0x19,
	CRYPTO_ALGOFAM_ECDSA = 0x2C,
	CRYPTO_ALGOFAM_ED25519 =0x17,
	CRYPTO_ALGOFAM_RSA =0x16,
	CRYPTO_ALGOFAM_SM2= 0x27}CsmSignatureGenerateAlgorithmFamily;
typedef enum{CRYPTO_ALGOMODE_CUSTOM= 0xFF,
	CRYPTO_ALGOMODE_NOT_SET = 0x00,
	CRYPTO_ALGOMODE_RSASSA_PKCS1_v1_5 =0x0b,
	CRYPTO_ALGOMODE_RSASSA_PSS = 0x0a}CsmSignatureGenerateAlgorithmMode;
...
/* CsmPrimitives */
typedef struct {
	CsmSignatureGenerateConfig signatureConfig;
	CsmSignatureVerifyConfig verifyConfig;
...
typedef  (*CsmCallback)(Crypto_JobType *job, Crypto_ResultType result) ;
