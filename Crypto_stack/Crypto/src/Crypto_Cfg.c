...
{CRYPTO_ALGOFAM_ECCSEC,CRYPTO_ALGOMODE_NOT_SET,CRYPTO_ALGOFAM_NOT_SET,CRYPTO_SIGNATUREGENERATE,TRUE};

/* struct for cryptoPrimitives used through verification process*/
const CryptoPrimitive verifyGenerateCryptoPrimitive = 
{CRYPTO_ALGOFAM_ECCSEC,CRYPTO_ALGOMODE_NOT_SET,CRYPTO_ALGOFAM_NOT_SET,CRYPTO_SIGNATUREVERIFY,TRUE};

/* struct for cryptoPrimitives used through HASH process*/
const CryptoPrimitive hashGenerateCryptoPrimitive =
{CRYPTO_ALGOFAM_SHA2_256,CRYPTO_ALGOMODE_NOT_SET,CRYPTO_ALGOFAM_NOT_SET,CRYPTO_HASH,TRUE};
